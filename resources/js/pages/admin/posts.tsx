...
export default function PostsPage({ posts, categories }: PostsPageProps) {
    ...
    const handleCKEditorChange = (_event: unknown, editor: { getData: () => string }) => {
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex flex-col gap-4 p-4">
                <div className="flex justify-between items-center mb-4">
                    <h1 className="text-2xl font-bold">Bài đăng</h1>
                ...
                <Dialog open={showCommentsModal} onOpenChange={setShowCommentsModal}>
                    <DialogContent className="sm:max-w-[600px]">
                        <DialogHeader>
                            <DialogTitle>Bình luận của {selectedPost?.title}</DialogTitle>
                            <DialogDescription>
                                Xem tất cả bình luận về bài viết này
                            </DialogDescription>
                        </DialogHeader>
                ...
                <Dialog open={showModal} onOpenChange={setShowModal}>
                    <DialogContent className="sm:max-w-[800px] max-h-[90vh] overflow-y-auto">
                        <DialogHeader>
                            <DialogTitle>{editPost ? 'Sửa bài viết' : 'Thêm bài viết'}</DialogTitle>
                            <DialogDescription>
                                {editPost ? 'Thay đổi bài đăng của bạn tại đây.' : 'Tạo bài đăng blog mới tại đây.'}
                            </DialogDescription>
                        </DialogHeader>
