    ...
    const handleDelete = (id: number) => {
        if (confirm('Bạn có chắc chắn muốn xóa danh mục này không?')) {
            router.delete(`/admin/categories/${id}`, {
                ...
                onError: (errors) => {
                    toast.error(errors.error || 'Không xóa được danh mục');
                },
            });
        }
    };
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        if (editCategory) {
            router.put(`/admin/categories/${editCategory.id}`, formData, {
                ...
                onError: (errors) => {
                    toast.error(errors.name || 'Lỗi khi sửa danh mục');
                },
            });
        } else {
            router.post('/admin/categories', formData, {
                ...
                onError: (errors) => {
                    toast.error(errors.name || 'Lỗi khi thêm danh mục');
                },
            });
        }
    };
                ...
                <Dialog open={showModal} onOpenChange={setShowModal}>
                    <DialogContent className="sm:max-w-[425px]">
                        <DialogHeader>
                            ...
                            <DialogDescription>
                                {editCategory ? 'Thực hiện thay đổi cho danh mục của bạn tại đây.' : 'Tạo một danh mục mới ở đây.'}
                            </DialogDescription>
                        </DialogHeader>
