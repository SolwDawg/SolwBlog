...
class PostController extends Controller
{
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('admin.posts.index')->with('success', 'Bài viết đã được chỉnh sửa thành công!');
    }
    ...
    public function destroy(string $id)
    {
        ...
        $post->delete();
        return redirect()->route('admin.posts.index')->with('success', 'Bài viết đã được xoas thành công!');
    }
}
